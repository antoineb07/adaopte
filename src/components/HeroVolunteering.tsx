export default function HeroVolunteering() {
  return (
    <section
      ...
      className="relative h-60 md:h-125 w-full bg-[url('./images/alin-luna-8LfPXM6abRk-unsplash.jpg')] bg-cover bg-center bg-no-repeat py-24"
    >
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-4xl flex-col items-center justify-center px-4 text-center text-white sm:px-6 lg:px-8">
        <h1 className="mb-4 font-heading text-l md:text-4xl font-bold sm:text-5xl lg:text-6xl">
          Devenir bénévole
        </h1>
