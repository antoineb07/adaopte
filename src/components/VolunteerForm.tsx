      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
          ...
          <form className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="city" className="block text-sm font-medium text-heading mb-1.5">
              ...
              <div>
                <label htmlFor="zipcode" className="block text-sm font-medium text-heading mb-1.5">
            ...
            {/* Disponibilités */}
            <div>
              <label htmlFor="availability" className="block text-sm font-medium text-heading mb-1.5">
            ...
            {/* Motivation */}
            <div>
              <label htmlFor="motivation" className="block text-sm font-medium text-heading mb-1.5">
